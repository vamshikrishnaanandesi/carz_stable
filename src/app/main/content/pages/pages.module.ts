...
import { FranchiseeLoginComponent } from './authentication/franchisee-login/franchisee-login.component';
import { FranchiseeLoginModule } from './authentication/franchisee-login/franchisee-login.module';
const routes = [
    {
        path        : 'login-2',
    ...
    },
    {
        ...
        loadChildren: './authentication/franchisee-login/franchisee-login.module#FranchiseeLoginModule'
    }
];
@NgModule({
    imports: [
