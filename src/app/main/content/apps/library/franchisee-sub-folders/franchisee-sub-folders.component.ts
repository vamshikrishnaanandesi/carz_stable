...
@Component({
  selector: 'fuse-franchisee-sub-folders',
  templateUrl: './franchisee-sub-folders.component.html',
  styleUrls: ['./franchisee-sub-folders.component.scss']
})
export class FranchiseeSubFoldersComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private router: Router, public dialog: MatDialog, private httpService: LibraryService) {
  ...
  ngOnInit() {
    ...
    // this.get_folder_list(this.route.snapshot.params['id']);
